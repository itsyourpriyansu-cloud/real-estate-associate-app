...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `User` (`user.ts`)          | `id, role (ASSOCIATE\|TEAM_LEAD\|CLIENT), fullName, phone, email?, avatarUrl?, associateCode, designation, teamName?, sponsorId?, joinedAt, status (ACTIVE\|INACTIVE), reraRegistration?` (demo label only). `sponsorId` is the direct upline; the chain is the My Team tree    |
...
| `Project` (`project.ts`)    | `id, name, developerName, location, city, status (ONGOING\|COMPLETED\|UPCOMING), hero/thumbnail, startingPrice, maxPrice?, min/maxPlotAreaSqYd, availableUnits, totalUnits, reraNumber?, possessionLabel?, description, amenities[], highlights[]` — refined: available ≤ total |
...
| Table         | Count | Notes                                                                                                                                                                                                                                                                |
| ------------- | ----- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| users         | 19    | Associate _K. V. Raghunath Reddy_ (Senior Associate, YH-APL2-1048, YHIPL2), a team lead, a client (Simple Login), 14 YHIPL2 members (9 in the associate's downline: 4 direct, 4 at level 2, 1 at level 3) and 2 in another team. Team = 16, My Team = 9              |
...
Project statuses: Real Rise and Northgate County are `COMPLETED`; Aurelia Greens and Cedar Enclave are `ONGOING`.
